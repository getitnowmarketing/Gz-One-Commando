...
#define SENSOR_CAMERA_QH_SIZE		1
#define SENSOR_CAMERA_QL_SIZE		2

#define SENSOR_CAMERA_1MP_SIZE		3
#define SENSOR_CAMERA_2MP_SIZE		4
#define SENSOR_CAMERA_3MP_SIZE		5
#define SENSOR_CAMERA_5MP_SIZE		6
...
#define CAMERA_SCENE_MODE_NIGHT		1
