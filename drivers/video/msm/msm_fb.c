					...
					enum led_brightness value)
{
	...
	msm_fb_set_backlight(mfd, value, 1);
}
			...
			unsigned long arg)
{
    ...
    case MSMFB_CUSTOM_1 :
        ...
        ret = mddi_ta8851_standby_ctl(1);
        break;

    case MSMFB_CUSTOM_2 :
        
        ret = mddi_ta8851_standby_ctl(0);
        break;

    case MSMFB_CUSTOM_3 :
        
        ret = mddi_ta8851_deep_standby_ctl(1);
        break;

    case MSMFB_CUSTOM_4 :
        
        ret = mddi_ta8851_deep_standby_ctl(0);
        break;

    case MSMFB_CUSTOM_5 :
        
        mddi_ta8851_set_idle_state();
        ret = 0;
        break;
    ...
    case MSMFB_CUSTOM_6 :
        ...
        mddi_ta8851_register_access_packet(reg_data.reg_addr, reg_data.set_data);
        ret = 0;
        break;
    ...
    case MSMFB_CUSTOM_7 :
        ...
        ret = mddi_ta8851_mdp_vsync_freq_check(&vsync_ave);
    ...
    case MSMFB_CUSTOM_8:
    {
        ...
        mddi_ta8851_set_vsync_freq(&vsync_freq, (void *)mfd);
        ret = 0;
        break;
    }
    ...
    case MSMFB_CUSTOM_9:
    {
        ...
        ret = mddi_ta8851_user_request_ctrl(&user_req);
        if (ret)
        {
            break;
        }
    ...
    case MSMFB_CUSTOM_10 :
        mddi_ta8851_set_standby_ctl(1);
        ret = 0;
        break;

    case MSMFB_CUSTOM_11 :
        mddi_ta8851_set_standby_ctl(0);
        ret = 0;
        break;
