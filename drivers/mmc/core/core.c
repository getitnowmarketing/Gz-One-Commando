...
void mmc_rescan(struct work_struct *work)
{
	...
	if (sdcc_host->plat->status_irq) {
		free_irq( sdcc_host->plat->status_irq, sdcc_host );
		if( sdcc_host->eject )	
		{
			ret = request_threaded_irq(sdcc_host->plat->status_irq, NULL,
